...
- **Before committing:** `python3 tools/precedent_check.py` — what matters
  ...
  from 2026-09-14; on 2026-09-21 the vendored engine deleted it on refresh,
  ...
  there is no after-the-push gate here any more, and none of the older ones
  is coming back: the check runs before the push, or it does not run.
