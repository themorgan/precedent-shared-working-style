...
**2026-09-23: moved here from the universal catalogue.** Raised in a
cross-repo practice-placement review as squarely working-style's own
subject -- how a session works alongside the person it is working with --
rather than something every Precedent consumer needs regardless of team.
Morgan approved the move; the universal copy is deduplicated and points
here.
